...
library(caTools)
#book rating data
book_rate_data <- read.csv('C:/Users/DINESH/Desktop/BOOK1.csv')
...
recommended_items2 <- predict(book_recomm_model2, book_rate_data_matrix[c(10:35),], n=5)
